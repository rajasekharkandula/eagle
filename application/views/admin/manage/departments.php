				...
				<table class="table table-bordered dataTable">
					...
					<tbody>
					  ...
					  <tr>
						...
						<td><a href="<?php echo base_url('admin/department/'.$d->id); ?>" class="btn btn-sm"><i class="fa fa-pencil-square-o"></i> Edit</a><button class="btn btn-sm removeuser" data-id="<?php echo $d->id; ?>"><i class="fa fa-trash"></i> Remove</button></td>
					  </tr>
					  <?php } ?>
					</tbody>
				  </table>
