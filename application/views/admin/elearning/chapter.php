						...
						<form id="course_form">
							...
							<table class="table table-bordered">
									...
									<tbody id="assessments">
									  <?php foreach($selected_asmts as $a){ ?>
									  <tr>
							...
							<div class="text-center mb-20">
								...
								<a href="<?php echo base_url('admin/elearning/content/'.$id); ?>" class="btn">Cancel</a>
							</div>
						</form>
					</div>
				</div>
		  ...
		  <div class="modal-body">
			<table class="table table-bordered">
				...
				<tbody>
				  ...
				  <tr>
					<td><input type="checkbox" class="assessments" data-name="<?php echo $a->name; ?>" data-questions="<?php echo $a->questions; ?>" value="<?php echo $a->id; ?>"></td>
