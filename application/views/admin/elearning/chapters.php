				...
				<div class="col-md-9">
					<div class="box">
						<div class="row mb-10">
							...
							<div class="col-md-6">
								<a href="<?php echo base_url('admin/elearning/chapter/'.$id.'/'.$section_id); ?>" class="btn pull-right">Add chapter</a>
							</div>
						</div>
						<table class="table table-bordered">
							...
							<tbody>
							  ...
							  <tr>
								...
								<td><a href="<?php echo base_url('admin/elearning/chapter/'.$c->course_id.'/'.$c->section_id.'/'.$c->id); ?>" class="btn btn-sm" data-id="<?php echo $c->id; ?>"><i class="fa fa-pencil"></i> Edit</a></td>
							  </tr>
							  <?php $i++;} ?>
							</tbody>
						</table>
